    ...
    try {
        ...
        const resultHTML = `
            ...
            <div class="result-additional">
                ⚠️ Важно! Средний опыт за раунд — это лишь приблизительное значение, не отражающее точную цифру.<br>
                ...
                - Уровень тотемов (влияет на количество получаемого опыта),<br>
